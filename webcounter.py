    ...
    for x in freq:
     ...
     #       print (x,freq[x])
      ...
      #      print (x,freq[x])
        #print(x,freq[x])
    for x in freq:
        if freq[x] >a and freq[x] < b:
            #print (x)
            words1.add(x)
    #for pair in freq.items():
     #   print (pair[0],pair[i])
        
    #return sortedByValue[0:3],w1,w2,a,b # return the top 3 terms and their frequencies 
    return words1

if __name__=='__main__':
    print(run('http://tedlappas.com/wp-content/uploads/2016/09/textfile.txt','the','and'))
